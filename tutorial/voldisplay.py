...
MY_TEMP_PATH="/tmp/volume_display_running.lock"
...
class VolDisplay(Gtk.Window):
    ...
    def prolongLiving(self):
        """ Prolongs the living time of this object. Therefore, the LIVING_ID will get removed from the timeout manager and will get replaced by a new one. """
